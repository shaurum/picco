# Модуль дискретного ввода PICCO-P5-DI 
...
<div style="display: flex; gap: 2rem; align-items: flex-start; margin: 1rem 0;">
    ...
    <div style="flex: 1; text-align: justify;">
        ...
        - PICCO-P5-DI (без покрытия)<br>
        - PICCO-P5-DI-V (с лаковым покрытием)</p>
...
Byte_Lo содержит состояние каналов 1-8, а Byte_Hi - каналов 9-16.

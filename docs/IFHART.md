# Модуль интерфейсный CAN PICCO-P5-IFHART
...
Модуль интерфейсный HART (арт. PICCO-P5-IFHART) является 4-канальным модулем расширения и предназначен для приема сигналов по интерфейсу HART.
</div>

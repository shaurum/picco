# Модуль ввода питания PICCO-P5-SPPM
...
Модуль ввода дополнительного питания (SPPM) (арт. PICCO-P5-SPPM) является модулем расширения и предназначен для обеспечения питания модулей.
...
По умолчанию, без установки перемычки, модуль PICCO-P5-SPPM подает питание только в левую сторону.

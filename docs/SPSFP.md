# Модуль оконечный PICCO-P5-SPSFP

## Общие сведения

??? example "Страница на разработке"
    На текущий момент информация и изображения могут быть недостоверны. 

<div class="grid cards" markdown>

![Image title](img/modules/SPTM.png){ width="250" align=left  }
Модуль оконечный (SPSFP) (арт. PICCO-P5-SPSFP) является модулем расширения и предназначен для перехода с внутренней шины на внешнюю шину Ethernet через порт SFP.

...
Сумма потребляемой мощности всех модулей расширения, стоящих справа от рассматриваемого [Модуля ввода питания SPPM]() до следующего, **включая сам модуль ввода питания**, не должна превышать 48 Вт. 

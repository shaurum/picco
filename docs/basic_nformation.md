...
Такой механизм позволяет на высокой скорости управлять до 65535 устройств в одной сети без ограничения в топологии сети. Причем для организации различных топологий не нужны хабы или коммутаторы. 1

![Принцип работы EtherCAT](EthercatOperatingPrincipl.gif)

...
Транспортирование модулей контроллера производится в упаковке изготовителя в соответствии с [разделом "Упаковка"](#упаковка). Модули контроллера могут транспортироваться на любые расстояния всеми видами транспорта в крытых транспортных средствах в соответствии с правилами перевозки грузов, действующими на данном виде транспорта.

Модули контроллера хранить в упаковке изготовителя в соответствии с [разделом "Упаковка"](#упаковка), в крытых складских помещениях, защищённых от атмосферных осадков и почвенной влаги, на расстоянии не менее 1 метра от отопительных приборов в следующих условиях: при температурах от минус 14 °С до плюс 40 °С и относительной влажности воздуха от 25 % до 70 %.

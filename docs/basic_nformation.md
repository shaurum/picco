...
<div style="text-align: center; margin-bottom: 10px;">
    <img src="img/animation/EthercatOperatingPrincipl.gif" alt="Принцип работы EtherCAT" style="display: inline-block;">
</div>
